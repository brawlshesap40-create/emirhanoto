...
import { updateCreditApplicationAction } from "@/lib/credit-applications/actions";

type Status = "yeni" | "gorusuluyor" | "sonuclandi";

export function CreditApplicationResponseForm({
  id,
  initialStatus,
  adminNote,
}: {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      try {
        await updateCreditApplicationAction(id, { status, adminNote });
