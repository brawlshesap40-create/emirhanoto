...
import { updateTestDriveRequestAction } from "@/lib/test-drive/actions";

type Status = "yeni" | "onaylandi" | "tamamlandi" | "iptal";

export function TestDriveResponseForm({
  id,
  initialStatus,
  initialAdminNote,
}: {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      try {
        await updateTestDriveRequestAction(id, {
          status,
    ...
    <form onSubmit={handleSubmit} className="space-y-4 rounded-xl border border-border bg-card p-5">
      ...
      <div className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Randevu saati, görüşme notları..."
        />
      </div>
